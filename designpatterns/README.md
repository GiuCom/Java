...
|                                        | **[Interpreter](comportamentali/interpreter)**                       | Definisce una rappresentazione della grammatica per un linguaggio e un interprete per le frasi del linguaggio.        |
|                                        | **[Iterator](comportamentali/iterator)**                             | Fornisce un modo per accedere sequenzialmente agli elementi di un aggregato senza esporne la struttura.               |
